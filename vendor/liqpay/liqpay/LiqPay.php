...
class LiqPay
{
    ...
    public function api($path, $params = array(), $timeout = 5)
    {
        ...
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);      // Avoid MITM vulnerability http://phpsecurity.readthedocs.io/en/latest/Input-Validation.html#validation-of-input-sources
